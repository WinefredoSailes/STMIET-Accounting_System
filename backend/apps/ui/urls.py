...
urlpatterns = [
    ...
    path("ar/receipts/<int:pk>/edit/", views.receipt_edit, name="receipt_edit"),
    ...
    path("ar/invoices/<int:pk>/edit/", views.si_edit, name="si_edit"),
    path("ar/invoices/<int:pk>/print/", views.si_print, name="si_print"),
